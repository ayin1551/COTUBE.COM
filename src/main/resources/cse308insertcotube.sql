INSERT INTO account
VALUES('user1', 'password1', 1, 'user1answer', '/img/test/oldpp.jpg', 0);

INSERT INTO account
VALUES('user2', 'password2', 1, 'user2answer', 'img/test/oldpp.jpg', 0);

INSERT INTO account
VALUES('user3', 'password3', 2, 'user3answer', 'img/test/oldpp.jpg', 0);

INSERT INTO account
VALUES('admin1', 'pass1', 1, 'admin1answer', 'img/test/oldpp.jpg', 1);
...
INSERT INTO Folder
VALUES(4, 'user1', 'testseriesfolder', 1, 1);
...
INSERT INTO Comic
VALUES(4, 0, 'testseries', 1, curdate());

INSERT INTO Series
VALUES(1, 'garfield', 3, 'https://d1xfgk3mh635yx.cloudfront.net/sites/default/files/styles/original/public/image/featured/1028677-9-story-acquires-worldwide-rights-garfield-and-friends.jpg?itok=ruReKrJB');

INSERT INTO Series
VALUES(2, 'testseries', 4, 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ4TyAbTgJtsWlUB3SMaytFi9XsiniH1r2dX0n8jR_lDZthOKW3-A');
...
INSERT INTO RegularComic
VALUES(4, 2,  'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ0LyCEImuityCx-giYKJl5qBN2mszqrOjIuI7k4hfC0kJdu8lhWA','testseries comic', 4);
...
INSERT INTO RegularComic
VALUES(4,1,'fkdkf','fdjfkd',1);

DELETE from regularcomic where regular_comic_id = 4;
*/
